...
This intellectual property (IP) core was developed in the digital integrated
circuits lab at the Institute of Computer Technology, TU Wien. Vienna, April
2018.
...
raised and the hash is available at the `output' port.
