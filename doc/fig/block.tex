\begin{tikzpicture}[
	...
	\begin{scope}[anchor=east, every node/.append style={xshift=-.25cm, yshift=.6em}]
		...
		\draw[yshift=-2.5cm] (0,0) --  (2,0)node {reset}; 
		\draw[yshift=-3cm] (0,0) -- (2,0) node {valid\_in}; 
	\end{scope}

	\node (core) at (4,.5) [draw, anchor=north,inner sep=0, outer sep=0, minimum width=4cm, minimum height =4cm]{BLAKE2};
