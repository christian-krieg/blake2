...
%
\Cref{fig:signaling} shows the situation where a message block is fully compressed
...
\Cref{2messagehash}. These hash values matched the hash values from the C code
implementation.
